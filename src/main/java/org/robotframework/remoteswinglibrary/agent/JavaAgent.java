...
public class JavaAgent {
	...
	private static final String LOG_FILE = "C:\\Users\\SPR103\\AppData\\Local\\Temp\\java-agent-log.txt";
	...
	public static void premain(String agentArgument, Instrumentation instrumentation) {
		...
		try {
			...
			Thread findAppContext = new Thread(
					new FindAppContextWithWindow(host, port, apport, debug, closeSecurityDialogs));
